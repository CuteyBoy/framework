...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //渐变颜色设置
        mColors = new int[]{Color.WHITE,Color.WHITE,Color.parseColor("#FAAD66"),Color.parseColor("#F9822B"),Color.parseColor("#F9822B")};
        mDrawFilter = new PaintFlagsDrawFilter(0, Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);

        //初始化画笔
        mDegreePaint = new Paint();
        mDegreePaint.setColor(Color.parseColor("#FAAD66"));
        ...
        mProgressBarPaint.setColor(Color.parseColor("#F9822B"));

        mProgressValuePaint = new Paint();
        mProgressValuePaint.setColor(Color.parseColor("#F9822B"));
